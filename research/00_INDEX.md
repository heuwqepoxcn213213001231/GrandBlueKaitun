...
**Turn scope:** Phase 4 RE + Phase 5–9 Kaitun implemented. Entry `kaitun.lua`. Version **1.0.5**. Reports: `FINAL_IMPLEMENTATION_REPORT.md`, `FINAL_CHECKLIST.md`, `REMOTE_REGISTRY.md`, `PROGRESSION_FINAL.md`, `RUNTIME_FIXES.md`, `QUEST_EXECUTION_MATRIX.md`.
...
| `RUNTIME_FIXES.md` | Crash/runtime fixes (1.0.1 Folder islands; 1.0.2 Graves resolve; 1.0.3 Dialogue ImageButton Text; 1.0.4 Activate crash; 1.0.5 combat rate-limit + Dummy/Dash) |
