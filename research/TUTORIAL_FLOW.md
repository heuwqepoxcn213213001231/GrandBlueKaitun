...
| Mining | TutorialScreen Mining | first pickaxe equip | TutorialEvent client "Mining" | Data.TutorialsCompleted.Mining | TutorialScreen | TutorialLocal CloseGUI → FireServer | First Upgrade | IMPLEMENTED ContinueOverlay 1.1.11 (3 InputBegan, no UIS walk) |
