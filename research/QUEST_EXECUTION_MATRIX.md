...
| Basics | 5 | Anchor Town | Required | Invest | TotalStatPoints | — | — | Anchor Town | Introduction | Stats.investMinimum | requires one-point live before/after verification (Unused and Strength delta) | STATIC_VERIFIED | IMPLEMENTED_UNVERIFIED |
...
| Gate of Authority | 1 | Anchor Town | Open | Interact | Marine Gate | — | Marine Metal Gate | Anchor Town | Feral Dog | Quest.waitAtMarineGate | deferred when Strength below requirement; re-verify unlock credit on current live build | STATIC_VERIFIED | IMPLEMENTED_UNVERIFIED |
