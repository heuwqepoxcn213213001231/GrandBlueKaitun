...
|---|---|---|
| Fresh bootstrap | PARTIAL | Wait character + StatReplication; Introduction via live quest. 1.0.1 Folder islands. 1.0.2 Graves resolve + Talk validate. 1.0.3 Dialogue guiText. 1.0.4 clickGui Activated/Clicked (no Activate) |
